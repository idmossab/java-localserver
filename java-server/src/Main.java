...
public final class Main {
    ...
    public static void main(String[] args) {
        try {
            ...
            System.out.println("Config file read successfully. Host: " + parser.host + ", Ports: " + parser.ports + ", Client Body Limit: " + parser.clientBodyLimitBytes + " bytes"+", Error Pages: " + parser.errorPages);
        } catch (Exception e) {
